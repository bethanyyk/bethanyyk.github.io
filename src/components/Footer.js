  ...
  return (
    <div className="footer">
      <div className="say-hi-container">
        <div className="say-hi-box">
          <span className="say-hi-text">Find me on other platforms!</span>
        </div>
        <span className="arrow">→</span>
      </div>

      <a href="mailto:bethanyyerimk@gmail.com" target="_blank" rel="noopener noreferrer" className="plain">
        <button class="email-button">
          ...
          <p class="text">bethanyyerimk@gmail.com</p>
        </button>
      </a>
      
      <a href="https://www.linkedin.com/in/bethanyyk" target="_blank" rel="noopener noreferrer" className="plain">
        <button class="linkedin-button">
          ...
          <p class="text">bethanyyk</p>
        </button>
      </a>

      <a href="https://github.com/bethanyyk/" target="_blank" rel="noopener noreferrer" className="plain">
